export const eventsData = [
    {
        ...
        shortDescription: "An evening filled with laughter as Niroop Mohan brought his unique comedy style to life, entertaining the audience with hilarious takes on everyday situations.",
        thumbnail: "https://gradient-content-server.vercel.app/content/utsav25/gallery/joy/1.JPG",
        backgroundImage: "https://gradient-content-server.vercel.app/content/utsav25/gallery/joy/1.JPG",
        galleryImages: [
    ...
    },
    {
        ...
        shortDescription: "An epic online treasure hunt that challenged participants with intricate puzzles and high-stakes adventures, blending technology with mystery.",
        ...
        color: "cyan",
        volunteers: [
            "Fasi Owaiz Ahmed", "Varsha V Kumar", "Shriyans Nayak", "Suniksha Priya", "Ahas Kaushik",
            "Anirudh Kuppam", "Navit Mathur", "Shashank Bhat", "Sahana BK", "Channabasavanna"
        ]
    },
    {
        id: 3,
        title: "Sync or Sink",
        shortDescription: "A ultimate test of teamwork where participants had to synchronize perfectly or face the consequences, creating unforgettable moments of collaboration.",
...
export const gradientTeam = [
    {
        name: "Sudhanva Bharadwaj and C S Shashank Sharma",
        role: "Club Coordinators"
    },
    {
        name: "Pranav Veeraghanta and Siddarth Sahay",
        role: "Event Coordinators : Uncharted 3: Lost Voyage",
    },
    {
        name: "R Suman and Likith Chowdary",
        role: "Event Coordinators : Jokes on You Again",
    },
    {
        name: "Yashas Nandan And Vignesh Madan",
    ...
    {
        name: "Deepali U, Vinay Yele, Ashrit M and Krishna Saket",
        role: "Gradient Core Team",
    },
