              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center text-purple-100 mb-12">
                  <div className="group transform hover:scale-105 transition-transform duration-300">
                    ...
                    <h3 className="text-2xl md:text-3xl font-bold group-hover:text-white transition-colors">51+</h3>
                  ...
                  <div className="group transform hover:scale-105 transition-transform duration-300">
                    ...
                    <h3 className="text-2xl md:text-3xl font-bold group-hover:text-white transition-colors">3200+</h3>
                  ...
                  <div className="group transform hover:scale-105 transition-transform duration-300">
                    <Award className="text-purple-400 mx-auto mb-3 group-hover:text-purple-300 transition-colors" size={40} />
                    <h3 className="text-2xl md:text-3xl font-bold group-hover:text-white transition-colors">₹5.2L+</h3>
